...
// var btn = document.getElementById('dashboard-login');
// // // dashboard login
// btn.addEventListener('click', function(e){
//   e.preventDefault()

// //// window.ope   n('http://127.0.0.1:5500/index.html', '_self' )
...
// });
// })
// document.querySelector('#dashboard-login').addEventListener('click', function(e){
//   e.preventDefault(e)
